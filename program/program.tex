...
\item {\large\bf Bayesian statistics}\\[1ex]
  ...
  %%
  \begin{itemize}
  \item Bayesian-logic tutorial: The Monty Hall problem (Max or Luca; 15--20min)
  \item discussion/questions on the main points of Bayesian logic (15--20min)
  \item brief presentation of an open inference problem from neuroscience by
    one of the participants (5min)
  \item hands-on: group work and discussion (possibly dividing into small
    ...
    tutorial) (remaining time, ca.~40min)
  \item round-up and literature suggestions (last 5--10min)
  \end{itemize}
  % \begin{itemize}
...
\item {\large\bf Spatio-temporal patterns}\\[1ex]
  ...
  {\bf Proposed participants:} Pietro, Sepehr, Renato, Daniel M, Jakob, Junji, Luca, Jenia, Espen, Philipp, Johanna, Marcel, Lyuba, Jeyathevy\\[1ex]
  {\bf Schedule:} \alert{TBA}\\[1ex]
  Notes:
  \begin{itemize}
...
\item {\large\bf Graph theory: applications and toolboxes}\\[1ex]
  ...
  {\bf Proposed participants:} Daniel B, David, Alper, Simone, Claudia, Michael D, Tobias, Nicole, Steffen, Jeyashree, Sven, Max, Jyotika, Sonja, Abigail, Dima, Moritz, Tammo\\[1ex]
  {\bf Schedule:} \alert{TBA}\\[1ex]
  Notes:
  \begin{itemize}
...
\item {\large\bf Brain maps and connectomics}\\[1ex]
  ...
  {\bf Proposed participants:} Sacha, Julia, Lukas, Hannah, Rembrandt, Markus, Fred\\[1ex]
  {\bf Schedule:} \alert{TBA}\\[1ex]
  Notes:
  \begin{itemize}
...
\item {\large\bf Applying our insights and methods to networks/data outside neuroscience (knowledge export)}\\[1ex]
  ...
  % \begin{itemize}
  % \item other types of complex networks or data? 
  % \item social networks
  % \item German train system
  % \end{itemize}
\end{enumerate}
...
\item {\large\bf Brain-activity features: functional relevance or byproduct?}\\[1ex]
  ...
  {\bf Proposed participants:} Julia, Jakob, Nicole, Steffen, Hannah, Rembrandt, Fred, Marcel, Lyuba\\[1ex]
  %%
  {\bf Schedule:}
  \begin{itemize}
...
\item {\large\bf Forward models \& biophysically realistic multi-scale activity}\\[1ex]
  ...
  {\bf Proposed participants:} Simone, Sacha, Renato, Daniel M, Tobias, Luca, Espen, Michael B, Sonja, Carlos, Johanna, Markus, Tammo, Jeyathevy\\[1ex]
  {\bf Schedule:}
  %%
  \begin{itemize}
